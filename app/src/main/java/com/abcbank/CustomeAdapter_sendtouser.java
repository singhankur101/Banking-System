...
public class CustomeAdapter_sendtouser extends RecyclerView.Adapter<ViewHolder> {
    ...
    List<com.abcbank.Model> modelList;
    Context context;

    public CustomeAdapter_sendtouser(sendtouser sentoUser, List<com.abcbank.Model> modelList) {
    ...
    public void setFilter(ArrayList<com.abcbank.Model> newList){
