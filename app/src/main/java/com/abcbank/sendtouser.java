...
public class sendtouser extends AppCompatActivity {
    ...
    List<com.abcbank.Model> modelList_sendtouser = new ArrayList<>();
    RecyclerView mRecyclerView;
    RecyclerView.LayoutManager layoutManager;
    com.abcbank.CustomeAdapter_sendtouser adapter;
    ...
    private void showData(String phonenumber) {
        ...
        Cursor cursor = new com.abcbank.DatabaseHelper(this).readselectuserdata(phonenumber);
        while(cursor.moveToNext()){
            ...
            com.abcbank.Model model = new com.abcbank.Model(cursor.getString(0), cursor.getString(1), price);
            modelList_sendtouser.add(model);
        }

        adapter = new com.abcbank.CustomeAdapter_sendtouser(sendtouser.this, modelList_sendtouser);
        mRecyclerView.setAdapter(adapter);
    }

    public void selectuser(int position) {
       selectuser_phonenumber = modelList_sendtouser.get(position).getPhoneno();
        Cursor cursor = new com.abcbank.DatabaseHelper(this).readparticulardata(selectuser_phonenumber);
        while(cursor.moveToNext()) {
            ...
            new com.abcbank.DatabaseHelper(this).insertTransferData(date, name, selectuser_name, transferamount, "Success");
            new com.abcbank.DatabaseHelper(this).updateAmount(selectuser_phonenumber, Dselectuser_remainingamount.toString());
            calculateAmount();
            Toast.makeText(this, "Transaction Successful!", Toast.LENGTH_LONG).show();
            startActivity(new Intent(sendtouser.this, com.abcbank.user_list.class));
            finish();
        }
    }
    ...
    private void calculateAmount() {
        ...
        new com.abcbank.DatabaseHelper(this).updateAmount(phonenumber, remainingamount);
    }
        ...
        builder_exitbutton.setTitle("Do you want to cancel the transaction?").setCancelable(false)
                .setPositiveButton("yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        new com.abcbank.DatabaseHelper(sendtouser.this).insertTransferData(date, name, "Not selected", transferamount, "Failed");
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                ...
                ArrayList<com.abcbank.Model> newList = new ArrayList<>();
                for(com.abcbank.Model model : modelList_sendtouser){
