...
public class history_list extends AppCompatActivity {
    List<com.abcbank.Model> modelList_historylist = new ArrayList<>();
    RecyclerView mRecyclerView;
    RecyclerView.LayoutManager layoutManager;
    com.abcbank.CustomeAdapter_history adapter;
    ...
    private void showData() {
        ...
        while (cursor.moveToNext()) {
            ...
            com.abcbank.Model model = new com.abcbank.Model(cursor.getString(2), cursor.getString(3), price, cursor.getString(1), cursor.getString(5));
            modelList_historylist.add(model);
        }

        adapter = new com.abcbank.CustomeAdapter_history(history_list.this, modelList_historylist);
